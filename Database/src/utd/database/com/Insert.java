...
public class Insert {
  private static final String DUPLCATE_PRIMARY_KEY = "Primary key should be unique";
  private static final String NULL_VALUE = "Nullable Field can't be null";
  private static final String ERROR = "Error, while inserting a record";
  private static final String SUCCESS = "Record is inserted Successfully";
  ...
  public void insertRecord(String userCommand) {
    try {
      ...
      if (!isError) {
        ...
        BTree.tableName = utility.getSeletedDatabase() + "." + tableName + ".tbl";
