...
public class Create {
  private static final String ERROR_TABLE = "Error, while Creating a table";
  private static final String ERROR_DATABASE = "Error, while Creating a Database";
  private static final String SUCCESS_TABLE = "Record is created Successfully";
  private static final String SUCCESS_DATABASE = "Database is created Successfully";
