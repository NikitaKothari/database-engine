...
public class Basic
{
  private static final String ERROR = "Error, while fetching values from database";
  Utility utility = Utility.getInstance();
  
  public Basic() {}
  
  public void showTables(String userCommand) { try { RandomAccessFile database = new RandomAccessFile(utility.getSeletedDatabase() + ".tables.tbl", "rw");
