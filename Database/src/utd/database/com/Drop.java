...
public class Drop
{
  private static final String ERROR_TABLE = "Error, while dropping a table";
  private static final String ERROR_DATABASE = "Error, while dropping a Database";
  private static final String SUCCESS_TABLE = "Record is deleted Successfully";
  private static final String SUCCESS_DATABASE = "Database is deleted Successfully";
  Utility utility = Utility.getInstance();
  
  public Drop() {}
  
  public void table(String userCommand) { try { String[] tokens = userCommand.split(" ");
  ...
  public void database(String userCommand) {
    try {
      ...
      while (databases.getFilePointer() < databases.length()) {
        ...
        if ((isDeleted == 0) && 
          (databaseNameFromTable.equals(databaseName))) {
