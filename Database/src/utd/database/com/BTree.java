...
public class BTree
{
  ...
  public boolean writeLeafHeader(long pageStart, long pageEnd, int recordSize, int rightPointer) { try { RandomAccessFile table = new RandomAccessFile(tableName, "rw");
