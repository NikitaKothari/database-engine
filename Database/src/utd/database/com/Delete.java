...
public class Delete
{
  private static final String SUCCESS = "Record is deleted Successfully";
  private static final String ERROR = "Error, whiel deleting a record";
  Utility utility = Utility.getInstance();
  
  public Delete() {}
  
  public void delete(String userCommand) { try { String[] tokens = userCommand.split(" ");
      ...
      if (utility.isTablePresent(tableName, true)) {
        ...
        if (table.length() > 0L) {
          ...
          while (nextPage) {
            ArrayList<Short> keep = new ArrayList();
